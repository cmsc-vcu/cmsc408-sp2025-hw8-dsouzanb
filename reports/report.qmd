...
SELECT
  ...
  COUNT(CASE WHEN `Income Group` = 'Upper middle income' THEN 1 END) AS Upper_Middle,
  COUNT(CASE WHEN `Income Group` = 'Lower middle income' THEN 1 END) AS Lower_Middle,
